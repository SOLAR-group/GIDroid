...
/** 
 * DAO for table "PINE_TIME_ACTIVITY_SAMPLE".
*/
public class PineTimeActivitySampleDao extends AbstractDao<PineTimeActivitySample, Void> {
    ...
    /**
     * Properties of entity PineTimeActivitySample.<br/>
    ...
    */
    ...
    public PineTimeActivitySampleDao(DaoConfig config) {
        super(config);
    }
    
    public PineTimeActivitySampleDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PINE_TIME_ACTIVITY_SAMPLE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PINE_TIME_ACTIVITY_SAMPLE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, PineTimeActivitySample entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(PineTimeActivitySample entity) {
    ...
    /** @inheritdoc */
    @Override
    public PineTimeActivitySample readEntity(Cursor cursor, int offset) {
        PineTimeActivitySample entity = new PineTimeActivitySample( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, PineTimeActivitySample entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(PineTimeActivitySample entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(PineTimeActivitySample entity) {
        return null;
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM PINE_TIME_ACTIVITY_SAMPLE T");
    ...
    protected PineTimeActivitySample loadCurrentDeep(Cursor cursor, boolean lock) {
        PineTimeActivitySample entity = loadCurrent(cursor, 0, lock);
    ...
    public PineTimeActivitySample loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<PineTimeActivitySample> loadAllDeepFromCursor(Cursor cursor) {
        ...
        List<PineTimeActivitySample> list = new ArrayList<PineTimeActivitySample>(count);
    ...
    public List<PineTimeActivitySample> queryDeep(String where, String... selectionArg) {
