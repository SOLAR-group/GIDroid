 ...
 */
public class FitProActivitySample extends AbstractFitProActivitySample  implements java.io.Serializable {
    ...
    public FitProActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public FitProActivitySample(int timestamp, long deviceId, long userId, int steps, int rawKind, int heartRate, Integer caloriesBurnt, Integer distanceMeters, Integer spo2Percent, Integer pressureLowMmHg, Integer pressureHighMmHg, Integer activeTimeMinutes) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
        this.steps = steps;
        ...
        this.pressureLowMmHg = pressureLowMmHg;
        this.pressureHighMmHg = pressureHighMmHg;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getFitProActivitySampleDao() : null;
    }
    ...
    public Integer getPressureLowMmHg() {
        return pressureLowMmHg;
    }

    public void setPressureLowMmHg(Integer pressureLowMmHg) {
        this.pressureLowMmHg = pressureLowMmHg;
    }

    public Integer getPressureHighMmHg() {
        return pressureHighMmHg;
    }

    public void setPressureHighMmHg(Integer pressureHighMmHg) {
        this.pressureHighMmHg = pressureHighMmHg;
    }
