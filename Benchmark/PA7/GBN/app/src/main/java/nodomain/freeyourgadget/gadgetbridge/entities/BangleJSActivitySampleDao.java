...
/** 
 * DAO for table "BANGLE_JSACTIVITY_SAMPLE".
*/
public class BangleJSActivitySampleDao extends AbstractDao<BangleJSActivitySample, Void> {

    public static final String TABLENAME = "BANGLE_JSACTIVITY_SAMPLE";

    /**
     * Properties of entity BangleJSActivitySample.<br/>
    ...
    */
    ...
    public BangleJSActivitySampleDao(DaoConfig config) {
        super(config);
    }
    
    public BangleJSActivitySampleDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BANGLE_JSACTIVITY_SAMPLE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BANGLE_JSACTIVITY_SAMPLE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, BangleJSActivitySample entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(BangleJSActivitySample entity) {
    ...
    /** @inheritdoc */
    @Override
    public BangleJSActivitySample readEntity(Cursor cursor, int offset) {
        BangleJSActivitySample entity = new BangleJSActivitySample( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, BangleJSActivitySample entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(BangleJSActivitySample entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(BangleJSActivitySample entity) {
        return null;
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM BANGLE_JSACTIVITY_SAMPLE T");
    ...
    protected BangleJSActivitySample loadCurrentDeep(Cursor cursor, boolean lock) {
        BangleJSActivitySample entity = loadCurrent(cursor, 0, lock);
    ...
    public BangleJSActivitySample loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<BangleJSActivitySample> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<BangleJSActivitySample> list = new ArrayList<BangleJSActivitySample>(count);
    ...
    protected List<BangleJSActivitySample> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<BangleJSActivitySample> queryDeep(String where, String... selectionArg) {
