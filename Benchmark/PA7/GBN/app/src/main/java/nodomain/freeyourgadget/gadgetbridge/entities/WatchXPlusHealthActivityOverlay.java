...
/**
 * Entity mapped to table "WATCH_XPLUS_HEALTH_ACTIVITY_OVERLAY".
 */
public class WatchXPlusHealthActivityOverlay {
    ...
    public WatchXPlusHealthActivityOverlay(int timestampFrom, int timestampTo, int rawKind, long deviceId) {
    ...
    public WatchXPlusHealthActivityOverlay(int timestampFrom, int timestampTo, int rawKind, long deviceId, long userId, byte[] rawWatchXPlusHealthData) {
        this.timestampFrom = timestampFrom;
        this.timestampTo = timestampTo;
        this.rawKind = rawKind;
        this.deviceId = deviceId;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getWatchXPlusHealthActivityOverlayDao() : null;
    }
