 ...
 */
public class MakibesHR3ActivitySample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    private transient MakibesHR3ActivitySampleDao myDao;
    ...
    public MakibesHR3ActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public MakibesHR3ActivitySample(int timestamp, long deviceId, long userId, int steps, int rawKind, int heartRate) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
        this.steps = steps;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getMakibesHR3ActivitySampleDao() : null;
    }
