 ...
 */
public class CasioGBX100ActivitySample extends AbstractGBX100ActivitySample  implements java.io.Serializable {
    ...
    private transient CasioGBX100ActivitySampleDao myDao;
    ...
    public CasioGBX100ActivitySample() {
    }

    public CasioGBX100ActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public CasioGBX100ActivitySample(int timestamp, long deviceId, long userId, int rawKind, int steps, int calories) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getCasioGBX100ActivitySampleDao() : null;
    }
