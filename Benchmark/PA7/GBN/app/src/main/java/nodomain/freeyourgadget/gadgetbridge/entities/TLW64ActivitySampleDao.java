...
/** 
 * DAO for table "TLW64_ACTIVITY_SAMPLE".
*/
public class TLW64ActivitySampleDao extends AbstractDao<TLW64ActivitySample, Void> {

    public static final String TABLENAME = "TLW64_ACTIVITY_SAMPLE";

    /**
     * Properties of entity TLW64ActivitySample.<br/>
    ...
    */
    ...
    public TLW64ActivitySampleDao(DaoConfig config) {
        super(config);
    }
    
    public TLW64ActivitySampleDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TLW64_ACTIVITY_SAMPLE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TLW64_ACTIVITY_SAMPLE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TLW64ActivitySample entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(TLW64ActivitySample entity) {
    ...
    /** @inheritdoc */
    @Override
    public TLW64ActivitySample readEntity(Cursor cursor, int offset) {
        TLW64ActivitySample entity = new TLW64ActivitySample( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TLW64ActivitySample entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(TLW64ActivitySample entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(TLW64ActivitySample entity) {
        return null;
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM TLW64_ACTIVITY_SAMPLE T");
    ...
    protected TLW64ActivitySample loadCurrentDeep(Cursor cursor, boolean lock) {
        TLW64ActivitySample entity = loadCurrent(cursor, 0, lock);
    ...
    public TLW64ActivitySample loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<TLW64ActivitySample> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<TLW64ActivitySample> list = new ArrayList<TLW64ActivitySample>(count);
    ...
    protected List<TLW64ActivitySample> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<TLW64ActivitySample> queryDeep(String where, String... selectionArg) {
