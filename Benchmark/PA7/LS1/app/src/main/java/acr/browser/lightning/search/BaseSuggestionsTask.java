...
abstract class BaseSuggestionsTask {
     ...
     */
    @NonNull
    protected File downloadSuggestionsForQuery(@NonNull String query, String language, @NonNull Application app) {
    ...
    protected static boolean isNetworkConnected(@NonNull Context context) {
