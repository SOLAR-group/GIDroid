...
mRemote.transact(Stub.TRANSACTION_onWeatherRequestCompleted, _data, _reply, 0);
...
mRemote.transact(Stub.TRANSACTION_onLookupCityRequestCompleted, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
