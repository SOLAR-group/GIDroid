...
/** 
 * DAO for table "WATCH_XPLUS_ACTIVITY_SAMPLE".
*/
public class WatchXPlusActivitySampleDao extends AbstractDao<WatchXPlusActivitySample, Void> {

    public static final String TABLENAME = "WATCH_XPLUS_ACTIVITY_SAMPLE";

    /**
     * Properties of entity WatchXPlusActivitySample.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property RawWatchXPlusHealthData = new Property(3, byte[].class, "rawWatchXPlusHealthData", false, "RAW_WATCH_XPLUS_HEALTH_DATA");
    ...
    public WatchXPlusActivitySampleDao(DaoConfig config) {
        super(config);
    }
    
    public WatchXPlusActivitySampleDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WATCH_XPLUS_ACTIVITY_SAMPLE\" (" + //
                "\"TIMESTAMP\" INTEGER  NOT NULL ," + // 0: timestamp
                "\"DEVICE_ID\" INTEGER  NOT NULL ," + // 1: deviceId
                "\"USER_ID\" INTEGER NOT NULL ," + // 2: userId
                "\"RAW_WATCH_XPLUS_HEALTH_DATA\" BLOB," + // 3: rawWatchXPlusHealthData
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WATCH_XPLUS_ACTIVITY_SAMPLE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, WatchXPlusActivitySample entity) {
        stmt.clearBindings();
        ...
        if (rawWatchXPlusHealthData != null) {
            stmt.bindBlob(4, rawWatchXPlusHealthData);
        }
    ...
    @Override
    protected void attachEntity(WatchXPlusActivitySample entity) {
    ...
    /** @inheritdoc */
    @Override
    public WatchXPlusActivitySample readEntity(Cursor cursor, int offset) {
        WatchXPlusActivitySample entity = new WatchXPlusActivitySample( //
            cursor.getInt(offset + 0), // timestamp
            cursor.getLong(offset + 1), // deviceId
            cursor.getLong(offset + 2), // userId
            cursor.isNull(offset + 3) ? null : cursor.getBlob(offset + 3), // rawWatchXPlusHealthData
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, WatchXPlusActivitySample entity, int offset) {
        ...
        entity.setRawWatchXPlusHealthData(cursor.isNull(offset + 3) ? null : cursor.getBlob(offset + 3));
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(WatchXPlusActivitySample entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(WatchXPlusActivitySample entity) {
        return null;
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM WATCH_XPLUS_ACTIVITY_SAMPLE T");
    ...
    protected WatchXPlusActivitySample loadCurrentDeep(Cursor cursor, boolean lock) {
        WatchXPlusActivitySample entity = loadCurrent(cursor, 0, lock);
    ...
    public WatchXPlusActivitySample loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<WatchXPlusActivitySample> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<WatchXPlusActivitySample> list = new ArrayList<WatchXPlusActivitySample>(count);
    ...
    protected List<WatchXPlusActivitySample> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<WatchXPlusActivitySample> queryDeep(String where, String... selectionArg) {
