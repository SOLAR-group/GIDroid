 ...
 */
public class BangleJSActivitySample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    private transient BangleJSActivitySampleDao myDao;
    ...
    public BangleJSActivitySample() {
    }

    public BangleJSActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public BangleJSActivitySample(int timestamp, long deviceId, long userId, int steps, int rawKind, int heartRate) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
        this.steps = steps;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getBangleJSActivitySampleDao() : null;
    }
