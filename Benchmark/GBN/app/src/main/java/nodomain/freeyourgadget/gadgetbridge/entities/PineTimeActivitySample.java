 ...
 */
public class PineTimeActivitySample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    public PineTimeActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public PineTimeActivitySample(int timestamp, long deviceId, long userId, int rawKind, int steps, int heartRate) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getPineTimeActivitySampleDao() : null;
    }
