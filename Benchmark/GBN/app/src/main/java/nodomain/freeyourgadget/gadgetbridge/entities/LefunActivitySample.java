 ...
 */
public class LefunActivitySample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    public LefunActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public LefunActivitySample(int timestamp, long deviceId, long userId, int rawKind, int steps, int distance, int calories, int heartRate) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getLefunActivitySampleDao() : null;
    }
