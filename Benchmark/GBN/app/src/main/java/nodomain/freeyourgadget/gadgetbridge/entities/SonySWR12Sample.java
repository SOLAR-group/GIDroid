 ...
 */
public class SonySWR12Sample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    public SonySWR12Sample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public SonySWR12Sample(int timestamp, long deviceId, long userId, int heartRate, int steps, int rawKind, int rawIntensity) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getSonySWR12SampleDao() : null;
    }
