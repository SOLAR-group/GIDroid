...
public class DeviceDao extends AbstractDao<Device, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ParentFolder = new Property(7, String.class, "parentFolder", false, "PARENT_FOLDER");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DEVICE\" (" + //
                ...
                "\"MODEL\" TEXT," + // 5: model
                "\"ALIAS\" TEXT," + // 6: alias
                "\"PARENT_FOLDER\" TEXT);"); // 7: parentFolder
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Device entity) {
        ...
        if (parentFolder != null) {
            stmt.bindString(8, parentFolder);
        }
    }
    ...
    public Device readEntity(Cursor cursor, int offset) {
        Device entity = new Device( //
            ...
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7) // parentFolder
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Device entity, int offset) {
        ...
        entity.setParentFolder(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
     }
