...
/**
 * The B operator from this paper:
 ...
 */
public class InsertBreak extends InsertStatementEdit {
    ...
    /**
     * create a random {@link InsertBreak} for the given sourcefile, using the provided RNG
     *
     ...
     */
    public InsertBreak(String destinationFile, int destinationBlockID, int destinationChildInBlockID) {
    ...
    public static Edit fromString(String description) {
        ...
        return new InsertBreak(destFile, destBlock, destLine);
    }
